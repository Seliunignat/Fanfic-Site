...
export const TextEditPage = () => {
  ...
  const uploadImage = async (file, index) => {
    if (file) {
      try {
        ...
        await request(`/api/text/${textId}/updateChaptersImages`, 'POST', {chaptersImages})
  ...
  return (
    <>
      <Navbar windowPage="/text/edit"></Navbar>
      <DragDropContext
        onDragEnd={(params) => {
