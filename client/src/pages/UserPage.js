...
export const UserPage = () => {
    ...
    return(
        ...
        <main>
            <section className="bg-light" >
                <section className="border-bottom">
                    ...
                    <div className="d-flex justify-content-center">
                        ...
                        className="rounded-circle  position-absolute border border-white border-3" 
                        style={{width: '168px', marginTop: '-8rem'}}></img>                      
            ...
            <section className="bg-gray ml-2  d-flex justify-content-center ">
